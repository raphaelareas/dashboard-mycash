...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 relative">
      {/* Logo - canto superior esquerdo (reduzida em 15% e ajustada verticalmente) */}
      <div className="absolute left-6 z-10 flex items-center" style={{ top: '16px' }}>
        <div className="relative inline-block">
          <svg width="198" height="60" viewBox="0 0 188 29" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '102%', height: '102%' }}>
          ...
          {/* Label ALPHA - posicionado no canto direito inferior da logo */}
          <span className="absolute bottom-0 right-0 px-1.5 py-0.5 text-[7px] font-bold uppercase tracking-wider rounded border transform translate-x-1/2 translate-y-1/2" style={{ backgroundColor: '#E5E7EB', color: '#1F2937', borderColor: '#1F2937' }}>
            ALPHA
          </span>
        </div>
      </div>
      ...
      {/* Bloco centralizado: Título/Subtítulo + Card */}
