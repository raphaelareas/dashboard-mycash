...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 relative">
      {/* Logo - canto superior esquerdo (aumentada em 20% do tamanho original) */}
      <div className="absolute top-6 left-6 z-10 flex items-center">
        <div className="relative inline-block">
          <svg width="198" height="60" viewBox="0 0 188 29" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '120%', height: '120%' }}>
